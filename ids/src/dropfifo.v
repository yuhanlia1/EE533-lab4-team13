...
// /___/   /\     Timestamp : 01/30/2026 00:27:10
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/EE533/lab3/mini-ids3/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_1 (.A(XLXN_11[7:0]), 
                                  .B(XLXN_8[7:0]), 
                                  .EQ(XLXN_14));
   // synthesis attribute HU_SET of XLXI_1 is "XLXI_1_20"
   COMP8_MXILINX_dropfifo XLXI_2 (.A(XLXN_8[7:0]), 
                                  .B(XLXN_2[7:0]), 
                                  .EQ(XLXN_15));
   // synthesis attribute HU_SET of XLXI_2 is "XLXI_2_21"
   CB8CLE_MXILINX_dropfifo XLXI_3 (.C(clk), 
                                   .CE(XLXN_32), 
                                   .CLR(rst), 
                                   .D(XLXN_2[7:0]), 
                                   .L(XLXN_17), 
                                   ...
                                   .Q(XLXN_11[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_3 is "XLXI_3_18"
   CB8CE_MXILINX_dropfifo XLXI_4 (.C(clk), 
                                  .CE(XLXN_16), 
                                  .CLR(rst), 
                                  .CEO(), 
                                  .Q(XLXN_8[7:0]), 
                                  .TC());
   // synthesis attribute HU_SET of XLXI_4 is "XLXI_4_19"
   reg9B XLXI_5 (.ce(XLXN_27), 
                 .clk(clk), 
                 .clr(rst), 
                 .d(in_fifo[71:0]), 
                 .q(XLXN_10[71:0]));
   ...
   fifo XLXI_20 (.addra(XLXN_11[7:0]), 
                 .addrb(XLXN_8[7:0]), 
                 .clka(clk), 
                 .clkb(clk), 
                 .dina(XLXN_10[71:0]), 
                 .wea(XLXN_32), 
                 .doutb(out_fifo[71:0]));
   OR2 XLXI_21 (.I0(XLXN_3), 
                .I1(XLXN_4), 
                .O(XLXN_5));
   AND2B1 XLXI_22 (.I0(XLXN_17), 
                   .I1(XLXN_5), 
                   .O(XLXN_29));
   AND3B2 XLXI_23 (.I0(XLXN_15), 
                   .I1(XLXN_14), 
                   .I2(fiforead), 
                   .O(XLXN_16));
   VCC XLXI_24 (.P(XLXN_27));
endmodule
